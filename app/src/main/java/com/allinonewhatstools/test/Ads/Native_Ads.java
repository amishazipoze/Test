...
public class Native_Ads {
    ...
    public static void NativeFinalLoad(FrameLayout Adlayout, RelativeLayout bigNativeLayout) {
        Adlayout.removeAllViews();
        bigNativeLayout.setVisibility(0);
        ...
        if (!SplashActivity.isBigNatShow) {
            bigNativeLayout.setVisibility(8);
            return;
        }
        countofloop = 0;
    ...
    public static void LoadQurekaNative(FrameLayout Adlayout) {
        Adlayout.removeAllViews();
        View layout = LayoutInflater.from(MyApplication.getContext()).inflate(R.layout.act_ad_qureka_native, (ViewGroup) null, false);
        ...
        for (int i = 0; i < SplashActivity.adsKeyModelArrayList.size(); i++) {
            ...
            builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                public void onNativeAdLoaded(com.google.android.gms.ads.nativead.NativeAd unifiedNativeAd) {
                    com.google.android.gms.ads.nativead.NativeAdView adView12;
                    if (SplashActivity.isAttractButton) {
                        adView12 = (NativeAdView) LayoutInflater.from(MyApplication.getContext()).inflate(R.layout.act_ad_admob_native, (ViewGroup) null);
                    } else {
                        adView12 = (NativeAdView) LayoutInflater.from(MyApplication.getContext()).inflate(R.layout.act_ad_native_admob_old, (ViewGroup) null);
                    }
                    ...
                    Native_Ads.nativeAModels.add(nativeAModel);
                    Native_Ads.populateUnifiedNativeAdView(unifiedNativeAd, adView12);
                }
            });
            builder.withAdListener(new com.google.android.gms.ads.AdListener() {
                public void onAdFailedToLoad(LoadAdError loadAdError) {
                    Log.e(Native_Ads.TAG, "onAdFailedToLoad: " + loadAdError.toString());
                    Model_Native_Ad nativeAModel = new Model_Native_Ad();
    ...
    public static void LoadFbNative() {
        ...
        nativeAd.loadAd(nativeAd.buildLoadAdConfig().withAdListener(new NativeAdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                Native_Ads.isFbLoaded = false;
                Native_Ads.isFbShowed = false;
                Native_Ads.nativeAdFb = null;
            }

            public void onAdLoaded(Ad ad) {
//                com.facebook.ads.NativeAd nativeAd = com.facebook.ads.NativeAd.this;
                if (nativeAd != null && nativeAd == ad) {
                    Native_Ads.isFbLoaded = true;
                    Native_Ads.isFbShowed = false;
                    Native_Ads.nativeAdFb =nativeAd;
                    Native_Ads.inflateAd(nativeAd);
                }
            }

            public void onAdClicked(Ad ad) {
                Log.d(Native_Ads.TAG, "Native ad clicked!");
            }

            public void onLoggingImpression(Ad ad) {
                Log.d(Native_Ads.TAG, "Native ad impression logged!");
            }
        }).build());
    }
    ...
    public static void inflateAd(com.facebook.ads.NativeAd nativeAd) {
        ...
        int i = 0;
        LinearLayout adView = (LinearLayout) LayoutInflater.from(MyApplication.getInstance()).inflate(R.layout.act_ad__native_fb_container, nativefbAdLayout, false);
    ...
    public static void LoadFbNative01() {
        ...
        nativeAd.loadAd(nativeAd.buildLoadAdConfig().withAdListener(new NativeAdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                Native_Ads.isFbLoaded2 = false;
                Native_Ads.isFbShowed2 = false;
                Native_Ads.nativeAdFb2 = null;
            }

            public void onAdLoaded(Ad ad) {
                if (nativeAd != null && nativeAd == ad) {
                    Native_Ads.isFbLoaded2 = true;
                    Native_Ads.isFbShowed2 = false;
                    Native_Ads.nativeAdFb2 = nativeAd;
                    Native_Ads.inflateAd01(nativeAd);
                }
            }
    ...
    public static void inflateAd01(com.facebook.ads.NativeAd nativeAd) {
        ...
        int i = 0;
        LinearLayout adView = (LinearLayout) LayoutInflater.from(MyApplication.getInstance()).inflate(R.layout.act_ad__native_fb_container, nativefbAdLayout2, false);
